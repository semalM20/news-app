...
const Tech = () => {
  ...
  useEffect(() => {
    async function getData() {
      let url = `https://api.newscatcherapi.com/v2/latest_headlines?countries=IN&page_size=18&lang=en&when=24h&topic=tech`;
  ...
  return (
    <>
      <h1 className="display-5 text-center mt-4">Technology News</h1>
